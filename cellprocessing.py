...
def stats_format(params):
    ...
    if params.find_septum or params.find_openseptum:
        ...
        result.append(("Full Septum Median", 3))
        result.append(("Full Septum Median 75%", 3))
        result.append(("Full Septum Median 25%", 3))
        result.append(("Full Septum Median 10%", 3))
        result.append(("Early Sept Median", 3))
